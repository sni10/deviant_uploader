...
### ⭐ Mass Fave
- Автоматическое добавление в избранное из ленты
- Очередь с фоновой обработкой через worker
- Отслеживание и фильтрация девиаций из feed
- Массовые операции с избранным
- Веб-интерфейс управления

### 💬 Profile Broadcasting
- Отправка комментариев на профили ваших вотчеров
- Система шаблонов сообщений для повторного использования
- Выборочное управление получателями (выбор конкретных вотчеров)
- Фоновый worker с rate limiting
- Полный лог отправок со ссылками на профили и ID комментариев
- Соблюдение заголовка Retry-After

### Auto Comment
- Автокомментирование девиаций из watch/global feed
- Шаблоны комментариев с включением/отключением
- Очередь и worker с rate limiting
- Логи отправленных/ошибочных комментариев
...
Автоматическое комментирование девиаций из лент.

**Основные функции:**
- Управление шаблонами комментариев (создать/обновить/включить)
- Сбор девиаций из watch/global feed
- Управление очередью и worker
- Логи отправленных/ошибочных комментариев
